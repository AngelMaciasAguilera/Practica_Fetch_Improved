...
export const uiDesk = {
    ...
    generateDesk: () => {
        ...
        let arrayaux = [];
        //Le paso la referencia de mi objeto array para que se pueda realizar el volcado de datos y tener mi array de cartas posicionadas
        ...
        uiDesk.desk.forEach(card => {
            ...
            //Antes de anexarlas al contenedor principal de cartas compruebo que no esten dentro de mi array que contiene las cartas con su posicion guardadas
            arrayaux.forEach(cardaux => {
                console.log(cardaux.cardId == card.id);
            });
        });
    },
